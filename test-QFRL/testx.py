...
file1 = np.load('/Users/junjiehu/QuantumRL/projectQL/file1.npy', allow_pickle=True).item()
file2 = np.load('/Users/junjiehu/QuantumRL/projectQL/file2.npy', allow_pickle=True).item()
file3 = np.load('/Users/junjiehu/QuantumRL/projectQL/file3.npy', allow_pickle=True).tolist()
Deadend = np.load('/Users/junjiehu/QuantumRL/projectQL/Deadend.npy', allow_pickle=True).tolist()
buyable = np.load('/Users/junjiehu/QuantumRL/projectQL/buyable.npy', allow_pickle=True).tolist()
